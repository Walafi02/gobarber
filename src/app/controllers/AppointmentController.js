...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    /**
     * parsedate transforma string de data em timestemp
     * startOfHour transforma a hr de 10:30 para 10:00
     */
    ...
    const formatDate = format(hourStart, "'dia' dd 'de' MMMM', as' H:mm'h'", {
      locale: pt,
    });
